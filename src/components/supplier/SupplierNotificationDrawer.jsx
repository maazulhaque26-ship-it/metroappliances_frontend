  ...
  return (
    <>
      ...
      <div
        ...
        style={{ position: 'fixed', top: 0, right: 0, height: '100vh', width: 400, maxWidth: '100vw', background: 'var(--card,#fff)', boxShadow: '-4px 0 32px rgba(0,0,0,0.12)', zIndex: 1501, display: 'flex', flexDirection: 'column', fontFamily: 'Poppins, sans-serif', borderLeft: '1px solid var(--border,#E5E7EB)' }}
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 20px', borderBottom: '1px solid var(--border,#E5E7EB)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <FiBell size={18} color="#FF7A00" aria-hidden="true" />
