          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={7} style={{ padding: '48px', textAlign: 'center', color: 'var(--text-4,#9CA3AF)' }}>
                <div style={{ width: 44, height: 44, borderRadius: '50%', background: 'var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 10px' }}><FiTag size={18} style={{ color: 'var(--text-4)' }} aria-hidden="true" /></div>
