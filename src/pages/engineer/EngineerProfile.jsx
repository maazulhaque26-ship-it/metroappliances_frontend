...
export default function EngineerProfile() {
  ...
  return (
    <div style={{ padding: '24px 24px 80px', fontFamily: 'Poppins, sans-serif', maxWidth: 640 }}>
      ...
      {msg && (
        <div role="status" style={{ background: '#D1FAE5', color: '#065F46', padding: '10px 14px', borderRadius: 8, marginBottom: 16, fontSize: 13, fontWeight: 500 }}>
          {msg}
        </div>
      )}
      ...
      <div style={{ background: '#fff', borderRadius: 14, padding: 20, border: '1px solid #E5E7EB', marginBottom: 16 }}>
        ...
        <div
          role="progressbar"
          aria-valuenow={engineer.currentWorkload || 0}
          aria-valuemin={0}
          aria-valuemax={engineer.maxWorkload || 6}
